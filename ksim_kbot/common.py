...
#     magnitude_range: tuple[float, float] = attrs.field(default=(0.0, 0.0))
...
#             rng,
#             minval=self.magnitude_range[0],
#             maxval=self.magnitude_range[1],
#         )
...
#         # random_forces = random_forces * force_scales + data.qvel[:6]
