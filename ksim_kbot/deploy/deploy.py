...
# NOTE - replace this with new xax logic
...
actuator_list: list[Actuator] = [
    # Right arm (nn_id 0-4)
    Actuator(actuator_id=21, nn_id=0, kp=100.0, kd=4.0, max_torque=48.0, joint_name="dof_right_shoulder_pitch_03"),
    Actuator(actuator_id=22, nn_id=1, kp=100.0, kd=4.0, max_torque=48.0, joint_name="dof_right_shoulder_roll_03"),
    Actuator(actuator_id=23, nn_id=2, kp=40.0, kd=2.0, max_torque=13.0, joint_name="dof_right_shoulder_yaw_02"),
    Actuator(actuator_id=24, nn_id=3, kp=40.0, kd=2.0, max_torque=13.0, joint_name="dof_right_elbow_02"),
    Actuator(actuator_id=25, nn_id=4, kp=20.0, kd=2.0, max_torque=11.0, joint_name="dof_right_wrist_00"),
    # Left arm (nn_id 5-9)
    Actuator(actuator_id=11, nn_id=5, kp=100.0, kd=4.0, max_torque=48.0, joint_name="dof_left_shoulder_pitch_03"),
    Actuator(actuator_id=12, nn_id=6, kp=100.0, kd=4.0, max_torque=48.0, joint_name="dof_left_shoulder_roll_03"),
    Actuator(actuator_id=13, nn_id=7, kp=40.0, kd=2.0, max_torque=13.0, joint_name="dof_left_shoulder_yaw_02"),
    Actuator(actuator_id=14, nn_id=8, kp=40.0, kd=2.0, max_torque=13.0, joint_name="dof_left_elbow_02"),
    Actuator(actuator_id=15, nn_id=9, kp=20.0, kd=2.0, max_torque=11.0, joint_name="dof_left_wrist_00"),
    # Right leg (nn_id 10-14)
    Actuator(actuator_id=41, nn_id=10, kp=150.0, kd=8.0, max_torque=96.0, joint_name="dof_right_hip_pitch_04"),
    Actuator(actuator_id=42, nn_id=11, kp=150.0, kd=8.0, max_torque=48.0, joint_name="dof_right_hip_roll_03"),
    Actuator(actuator_id=43, nn_id=12, kp=100.0, kd=4.0, max_torque=48.0, joint_name="dof_right_hip_yaw_03"),
    Actuator(actuator_id=44, nn_id=13, kp=150.0, kd=8.0, max_torque=96.0, joint_name="dof_right_knee_04"),
    Actuator(actuator_id=45, nn_id=14, kp=40.0, kd=8.0, max_torque=13.0, joint_name="dof_right_ankle_02"),
    # Left leg (nn_id 15-19)
    Actuator(actuator_id=31, nn_id=15, kp=150.0, kd=8.0, max_torque=96.0, joint_name="dof_left_hip_pitch_04"),
    Actuator(actuator_id=32, nn_id=16, kp=150.0, kd=8.0, max_torque=48.0, joint_name="dof_left_hip_roll_03"),
    Actuator(actuator_id=33, nn_id=17, kp=100.0, kd=4.0, max_torque=48.0, joint_name="dof_left_hip_yaw_03"),
    Actuator(actuator_id=34, nn_id=18, kp=150.0, kd=8.0, max_torque=96.0, joint_name="dof_left_knee_04"),
    Actuator(actuator_id=35, nn_id=19, kp=40.0, kd=8.0, max_torque=13.0, joint_name="dof_left_ankle_02"),
]

home_position = {
    21: 0.0,  # dof_right_shoulder_pitch_03
    22: 0.0,  # dof_right_shoulder_roll_03
    23: 0.0,  # dof_right_shoulder_yaw_02
    24: 90.0,  # dof_right_elbow_02
    25: 0.0,  # dof_right_wrist_00
    11: 0.0,  # dof_left_shoulder_pitch_03
    12: 0.0,  # dof_left_shoulder_roll_03
    13: 0.0,  # dof_left_shoulder_yaw_02
    14: -90.0,  # dof_left_elbow_02
    15: 0.0,  # dof_left_wrist_00
    41: -13.6,  # dof_right_hip_pitch_04
    42: 0.0,  # dof_right_hip_roll_03
    43: 0.0,  # dof_right_hip_yaw_03
    44: -29.25,  # dof_right_knee_04
    45: 13.5,  # dof_right_ankle_02
    31: 13.6,  # dof_left_hip_pitch_04
    32: 0.0,  # dof_left_hip_roll_03
    33: 0.0,  # dof_left_hip_yaw_03
    34: 29.25,  # dof_left_knee_04
    35: -13.5,  # dof_left_ankle_02
}
...
class DeployConfig:
    ...
    rnn_carry_shape: tuple[int, int] = field(
        default=(5, 256), metadata={"help": "Shape of the RNN carry. (num_layers, hidden_size)"}
    )
...
async def run_policy(config: DeployConfig) -> None:
    ...
    async def get_obs(kos_client: pykos.KOS) -> dict:
        ...
        pos_obs -= np.deg2rad(list(home_position.values()))
        ...
        # NOTE - remove that
        projected_gravity = get_projected_gravity_vector_from_quat(
            np.array([quaternion.w, quaternion.x, quaternion.y, quaternion.z]),
        )
    ...
    async def send_action(raw_action: np.ndarray, kos_client: pykos.KOS) -> None:
        ...
        position_target = np.rad2deg(raw_position * config.action_scale) + list(home_position.values())
        velocity_target = raw_velocity * config.action_scale
