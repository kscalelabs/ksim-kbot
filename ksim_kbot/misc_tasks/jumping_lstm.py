...
from ksim_kbot.standing.standing_lstm import KbotStandingLSTMTask, KbotStandingLSTMTaskConfig
...
if __name__ == "__main__":
    ...
    #   python -m ksim_kbot.misc_tasks.jumping
    # To visualize the environment, use the following command:
    #   python -m ksim_kbot.misc_tasks.jumping run_environment=True
