...
class KbotWalkingTask(KbotStandingTask[Config], Generic[Config]):
    ...
    def get_observations(self, physics_model: ksim.PhysicsModel) -> list[ksim.Observation]:
        ...
        return [
            ...
            common.ActPosObservation.create(physics_model=physics_model, action_index=0, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=1, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=2, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=3, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=4, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=5, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=6, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=7, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=8, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=9, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=10, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=11, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=12, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=13, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=14, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=15, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=16, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=17, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=18, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=19, noise=0.0),
            common.ActPosObservation.create(physics_model=physics_model, action_index=20, noise=0.0),
        ]
